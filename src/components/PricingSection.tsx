...
const plans = [
  ...
  {
    name: "Sistema Web / Logística",
    price: "R$ 4.500",
    desc: "Para quem precisa automatizar processos, gerenciar dados ou controlar operações.",
    features: [
      "Tudo do plano Site Completo",
      "Cadastro, login e controle de acesso",
      "Banco de dados e painel de gestão",
      "Relatórios e exportação de dados",
      "API REST e integrações externas (mapas, rotas, rastreamento)",
      "Ideal para logística, operações e gestão de processos",
